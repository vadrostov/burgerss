        ...
        <td bgcolor="#000000"><table align="left" valign="top"  width="770" height="1000" border="0" cellspacing="0">
            ...
            <tr align="center" valign="top">
                <td bgcolor="#000000"  ><table width="760" border="0" cellspacing="0" align="center" valign="top">
                    ...
                    <table width="760" border="0" cellspacing="0" align="center" valign="top">
   <span style="color: #f0ffff; ">
                        <tbody><tr><td width="200">

                      Login:</td>

   <td width="200"><sf:input path="login"/></td></tr>

                        <tr> <td width="200">Password:</td>  <td width="200"><sf:password path="password"/></td></tr>

                       <tr>   <td width="200">Phone number: </td> <td width="200"><sf:input path="phonenumber"/></td></tr>

                       <tr>   <td width="200">E-mail:</td> <td width="200"><sf:input path="email"/></td></tr>

                       <tr>  <td width="200"></td><td width="200"><input type="submit" class="button button1" value="Reg"/></td></tr>
