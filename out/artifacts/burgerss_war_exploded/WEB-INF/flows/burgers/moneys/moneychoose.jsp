        ...
        <td bgcolor="#000000"><table align="left" valign="top"  width="770" height="1000" border="0" cellspacing="0">
            ...
            <tr>
                <td bgcolor="#000000" align="center" valign="top" width="769" height="92"><table width="769" border="0" cellspacing="0">
                    <tbody>
                    <tr>
                        <td bgcolor="#000000" width="255" height="92">
            ...
            <tr align="center" valign="top">
                <td bgcolor="#000000"  ><table width="760" border="0" cellspacing="0" align="center" valign="top">
                    ...
                    <form:form>
                        ...
                        <label><input type="radio" name="money" value="nal"/> Наличные</label><br/>
                        <label><input type="radio" name="money" disabled value="emoney"/> Электронные деньги</label><br/>
                        <input type="submit" name="_eventId_moneyCh"  class="button button1" value="введите адрес" />
                    </form:form>
                    </tbody>
                </table></td>
            </tr>
