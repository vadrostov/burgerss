            ...
            <tr align="center" valign="top">
                <td bgcolor="#000000"  ><table width="760" border="0" cellspacing="0" align="center" valign="top">
                    ...
                    <table width="750" border="0" cellspacing="0" align="center" valign="top">
                        ...
                        <tbody><span style="color: #f0ffff; "><tr><td width="100"><br/>Введите имя:</td>
                        <input type="hidden" name="_flowExecutionKey"
                               value="${flowExecutionKey}"/>
                        <td width="200"><input type="text" name="name"/></td><tr><td width="100"></td><td width="200">
                        <input type="submit" name="_eventId_adressentered" class="button button1" value="введите Имя" /></td>
                        </tr>
                    </form:form>
