        ...
        <td bgcolor="#000000"><table align="left" valign="top"  width="770" height="1000" border="0" cellspacing="0">
            ...
            <tr align="center" valign="top">
                <td bgcolor="#000000"  ><table width="760" border="0" cellspacing="0" align="center" valign="top">
                    ...
                    <security:authorize access="hasRole('ROLE_USER')">${burgerOrder.user.}</security:authorize>
                    <form:form>
                        <span style="color: #f0ffff; "/>Введите адрес:
                        <input type="hidden" name="_flowExecutionKey"
                               value="${flowExecutionKey}"/>
                        <input type="text"  name="adress"/><br/>
                        <input type="submit" name="_eventId_adressEntered" class="button button1" value="введите адрес" />
                    </form:form>
                    </tbody>
                </table></td>
            </tr>
