        ...
        <td bgcolor="#000000"><table align="left" valign="top"  width="770" height="1000" border="0" cellspacing="0">
            ...
            <tr align="center" valign="top">
                <td bgcolor="#000000"  ><table width="760" border="0" cellspacing="0" align="center" valign="top">
                    ...
                    <a href="${pageContext.request.contextPath}/admin/menu">Изменить меню</a><br/></td></tr>
                    <tr><td width="100"><a href="${pageContext.request.contextPath}/admin/users">Пользователи</a><br/></td></tr>
                    <tr><td width="100"><a href="${pageContext.request.contextPath}/admin/orders">Заказы</a><br/></td></tr>
